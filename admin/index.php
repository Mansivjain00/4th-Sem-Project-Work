        ...
        <div class="row">
            <div class="col-md-12 p-1 d-flex align-items-center">
                ...
                <div class="button text-center">
                    <button class="btn btn-dark text-light"><a href="insert_product.php" class="nav-link text-dark my-1 mx-1 text-light">Insert Products</a></button>
                    <!-- <button class="btn btn-light"><a href="" class="nav-link text-dark my-1 mx-1">View Products</a></button> -->
                    <button class="btn btn-dark text-light"><a href="index.php?insert_category" class="nav-link text-dark my-1 mx-1 text-light">Insert Categories</a></button>
                    <!-- <button class="btn btn-light"><a href="" class="nav-link text-dark my-1 mx-1">View Categories</a></button> -->
                    <button class="btn btn-dark text-light"><a href="index.php?insert_brands" class="nav-link text-dark my-1 mx-1 text-light">Insert Brands</a></button>
